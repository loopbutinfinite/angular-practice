...
import { InputPropertyComponent } from './input-property-component/input-property-component';
import { InputPropertyMathComponent } from './input-property-math-component/input-property-math-component';
...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, EventHandlerComponent, EventHandlerButtonComponent, LandingPageComponent, IteratingComponent, DisplayCardsComponent, RouterLink, NavbarComponent, InputPropertyComponent, InputPropertyMathComponent],
  styleUrl: './app.css',
