...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, EventHandlerComponent, EventHandlerButtonComponent, LandingPageComponent, IteratingComponent, DisplayCardsComponent, RouterLink, NavbarComponent, InputPropertyComponent],
  styleUrl: './app.css',
