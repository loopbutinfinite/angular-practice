...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, EventHandlerComponent, EventHandlerButtonComponent, LandingPageComponent, IteratingComponent, DisplayCardsComponent],
  styleUrl: './app.css',
  template: `
    ...
    <app-display-cards-component></app-display-cards-component>
